...
def slice_and_mkdir(pdf_path):
    individual_pdfs_dir = os.path.splitext(os.path.basename(pdf_path))[0]      # Path to the directory containing 1 page pdfs
    ...
    for i in range(1, total_pages + 1):
        output_pdf = os.path.join(individual_pdfs_dir, f"{individual_pdfs_dir}_page_{i}.pdf")
